...
public class Recipe implements Parcelable
{
    ...
    protected Recipe(Parcel in) {
        ...
        in.readList(this.ingredients, (com.ricardorainha.cooking.model.Ingredient.class.getClassLoader()));
        in.readList(this.steps, (com.ricardorainha.cooking.model.Step.class.getClassLoader()));
